 ...
 * @param type 支付类型：[PayResultBean.TYPE_ALI]、[PayResultBean.PAY_WEIXIN]
 */
data class PayResultBean(val result: String, val type: String) {
    companion object {
         ...
         * 支付结果：成功
         */
        const val RESULT_SUCCESS = "pay_success"

        /**
         * 支付结果：取消
         */
        const val RESULT_CANCEL = "pay_cancel"
         ...
         * 支付类型：微信
         */
        const val TYPE_WEIXIN = "type_weixin"
    }
