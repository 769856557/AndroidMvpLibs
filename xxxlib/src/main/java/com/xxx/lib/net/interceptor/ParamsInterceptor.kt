package com.xxx.lib.net.interceptor
...
class ParamsInterceptor : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        val requestBuilder = chain.request().newBuilder().apply {
            addHeader("Token", TOKEN)//登陆成功后返回的token
            addHeader("Device-Name", DEVICE_NAME)//设备名称
            addHeader("Os-Name", OS_NAME)//系统名称
            addHeader("Os-Version", OS_VERSION)//系统版本
            addHeader("App-Version", APP_VERSION)//应用版本
        }
